...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field specifications on 'Item'
        db.create_table(u'items_item_specifications', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'items.item'], null=False)),
            ('specification', models.ForeignKey(orm[u'items.specification'], null=False))
        ))
        db.create_unique(u'items_item_specifications', ['item_id', 'specification_id'])


    def backwards(self, orm):
        # Removing M2M table for field specifications on 'Item'
        db.delete_table('items_item_specifications')
