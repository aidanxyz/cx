...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.views_count'
        db.add_column(u'items_item', 'views_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.pros_count'
        db.add_column(u'items_item', 'pros_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.cons_count'
        db.add_column(u'items_item', 'cons_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.views_count'
        db.delete_column(u'items_item', 'views_count')

        # Deleting field 'Item.pros_count'
        db.delete_column(u'items_item', 'pros_count')

        # Deleting field 'Item.cons_count'
        db.delete_column(u'items_item', 'cons_count')
