...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemImage.uploaded_by'
        db.add_column(u'items_itemimage', 'uploaded_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customauth.CustomUser']),
                      keep_default=False)

        # Adding field 'ItemImage.date_uploaded'
        db.add_column(u'items_itemimage', 'date_uploaded',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemImage.uploaded_by'
        db.delete_column(u'items_itemimage', 'uploaded_by_id')

        # Deleting field 'ItemImage.date_uploaded'
        db.delete_column(u'items_itemimage', 'date_uploaded')
