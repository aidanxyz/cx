...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.possible_duplicates'
        db.add_column(u'items_item', 'possible_duplicates',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['items.ItemPossibleDuplicates'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.possible_duplicates'
        db.delete_column(u'items_item', 'possible_duplicates_id')
