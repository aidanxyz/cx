...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemUsageExperience.date_verified'
        db.add_column(u'items_itemusageexperience', 'date_verified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 18, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemUsageExperience.date_verified'
        db.delete_column(u'items_itemusageexperience', 'date_verified')
