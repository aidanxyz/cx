...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.latest_feedback'
        db.add_column(u'items_item', 'latest_feedback',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='items_latest_set', null=True, to=orm['reviews.Feedback']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.latest_feedback'
        db.delete_column(u'items_item', 'latest_feedback_id')
