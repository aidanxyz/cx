...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.resolved_by'
        db.add_column(u'items_price', 'resolved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='resolver', null=True, to=orm['customauth.CustomUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'items_price', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='approver', null=True, to=orm['customauth.CustomUser']),
                      keep_default=False)

        # Deleting field 'Price.resolved_by'
        db.delete_column(u'items_price', 'resolved_by_id')
