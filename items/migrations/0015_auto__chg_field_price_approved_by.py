...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Price.approved_by'
        db.alter_column(u'items_price', 'approved_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['customauth.CustomUser']))

    def backwards(self, orm):

        # Changing field 'Price.approved_by'
        db.alter_column(u'items_price', 'approved_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['customauth.CustomUser']))
    ...
    models = {
        ...
        u'items.price': {
            ...
            'approved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approver'", 'null': 'True', 'to': u"orm['customauth.CustomUser']"}),
