...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ItemPossibleDuplicates'
        db.create_table(u'items_itempossibleduplicates', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('str_list', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('number', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ))
        db.send_create_signal(u'items', ['ItemPossibleDuplicates'])


    def backwards(self, orm):
        # Deleting model 'ItemPossibleDuplicates'
        db.delete_table(u'items_itempossibleduplicates')
