...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.latest_price'
        db.add_column(u'items_item', 'latest_price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.latest_price'
        db.delete_column(u'items_item', 'latest_price')
    ...
    models = {
        ...
        u'items.item': {
            ...
            'latest_price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
