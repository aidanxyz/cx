...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.cover_image'
        db.add_column(u'items_item', 'cover_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='cover_image', null=True, to=orm['items.ItemImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.cover_image'
        db.delete_column(u'items_item', 'cover_image_id')
    ...
    models = {
        ...
        u'items.item': {
            ...
            'cover_image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cover_image'", 'null': 'True', 'to': u"orm['items.ItemImage']"}),
