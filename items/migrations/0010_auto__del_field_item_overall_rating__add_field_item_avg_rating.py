...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.overall_rating'
        db.delete_column(u'items_item', 'overall_rating')

        # Adding field 'Item.avg_rating'
        db.add_column(u'items_item', 'avg_rating',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.overall_rating'
        db.add_column(u'items_item', 'overall_rating',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Item.avg_rating'
        db.delete_column(u'items_item', 'avg_rating')
    ...
    models = {
        ...
        u'items.item': {
            ...
            'avg_rating': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '3', 'decimal_places': '2'}),
