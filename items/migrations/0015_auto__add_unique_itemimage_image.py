...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ItemImage', fields ['image']
        db.create_unique(u'items_itemimage', ['image'])


    def backwards(self, orm):
        # Removing unique constraint on 'ItemImage', fields ['image']
        db.delete_unique(u'items_itemimage', ['image'])
