...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemImage.image_mini_thumb'
        db.add_column(u'items_itemimage', 'image_mini_thumb',
                      self.gf('django.db.models.fields.files.ImageField')(default='/', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ItemImage.image_cover_thumb'
        db.add_column(u'items_itemimage', 'image_cover_thumb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ItemImage.image_gallery_thumb'
        db.alter_column(u'items_itemimage', 'image_gallery_thumb', self.gf('django.db.models.fields.files.ImageField')(default='/', max_length=100))

    def backwards(self, orm):
        # Deleting field 'ItemImage.image_mini_thumb'
        db.delete_column(u'items_itemimage', 'image_mini_thumb')

        # Deleting field 'ItemImage.image_cover_thumb'
        db.delete_column(u'items_itemimage', 'image_cover_thumb')


        # Changing field 'ItemImage.image_gallery_thumb'
        db.alter_column(u'items_itemimage', 'image_gallery_thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'items.itemimage': {
            ...
            'image_cover_thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'image_gallery_thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'image_mini_thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['items.Item']"})
        },
        ...
        u'items.price': {
            ...
            'is_approved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['items.Item']"}),
            'resolved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resolver'", 'null': 'True', 'to': u"orm['customauth.CustomUser']"}),
