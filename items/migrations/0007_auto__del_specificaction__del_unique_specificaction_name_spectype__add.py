...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'items_specification', (
        ...
        db.send_create_signal(u'items', ['Specification'])

        # Adding unique constraint on 'Specification', fields ['name', 'spectype']
        db.create_unique(u'items_specification', ['name', 'spectype_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Specification', fields ['name', 'spectype']
        db.delete_unique(u'items_specification', ['name', 'spectype_id'])
        ...
        db.delete_table(u'items_specification')
