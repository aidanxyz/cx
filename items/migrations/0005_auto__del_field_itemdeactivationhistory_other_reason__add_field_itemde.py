...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ItemDeactivationHistory.other_reason'
        db.delete_column(u'items_itemdeactivationhistory', 'other_reason')

        # Adding field 'ItemDeactivationHistory.duplicate_of'
        db.add_column(u'items_itemdeactivationhistory', 'duplicate_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='duplicate_of', null=True, to=orm['items.Item']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ItemDeactivationHistory.other_reason'
        db.add_column(u'items_itemdeactivationhistory', 'other_reason',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ItemDeactivationHistory.duplicate_of'
        db.delete_column(u'items_itemdeactivationhistory', 'duplicate_of_id')
