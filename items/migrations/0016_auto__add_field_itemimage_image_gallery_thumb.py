...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemImage.image_gallery_thumb'
        db.add_column(u'items_itemimage', 'image_gallery_thumb',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemImage.image_gallery_thumb'
        db.delete_column(u'items_itemimage', 'image_gallery_thumb')
