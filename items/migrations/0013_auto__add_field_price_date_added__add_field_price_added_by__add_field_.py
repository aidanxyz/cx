...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Price.date_added'
        db.add_column(u'items_price', 'date_added',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 12, 0, 0)),
                      keep_default=False)

        # Adding field 'Price.added_by'
        db.add_column(u'items_price', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['customauth.CustomUser']),
                      keep_default=False)

        # Adding field 'Price.is_active'
        db.add_column(u'items_price', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Price.is_approved'
        db.add_column(u'items_price', 'is_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Price.approved_by'
        db.add_column(u'items_price', 'approved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='approver', to=orm['customauth.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Price.date_added'
        db.delete_column(u'items_price', 'date_added')

        # Deleting field 'Price.added_by'
        db.delete_column(u'items_price', 'added_by_id')

        # Deleting field 'Price.is_active'
        db.delete_column(u'items_price', 'is_active')

        # Deleting field 'Price.is_approved'
        db.delete_column(u'items_price', 'is_approved')

        # Deleting field 'Price.approved_by'
        db.delete_column(u'items_price', 'approved_by_id')
    ...
    models = {
        ...
        u'items.price': {
            ...
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customauth.CustomUser']"}),
            'approved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approver'", 'to': u"orm['customauth.CustomUser']"}),
