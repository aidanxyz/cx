...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FeedbackEditReason'
        db.delete_table(u'reviews_feedbackeditreason')

        # Deleting field 'FeedbackDeactivationHistory.reason'
        db.delete_column(u'reviews_feedbackdeactivationhistory', 'reason_id')


    def backwards(self, orm):
        # Adding model 'FeedbackEditReason'
        db.create_table(u'reviews_feedbackeditreason', (
            ('reason', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'reviews', ['FeedbackEditReason'])

        # Adding field 'FeedbackDeactivationHistory.reason'
        db.add_column(u'reviews_feedbackdeactivationhistory', 'reason',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['reviews.FeedbackEditReason']),
                      keep_default=False)
