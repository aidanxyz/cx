...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Detail.body'
        db.alter_column(u'reviews_detail', 'body', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Detail.body'
        db.alter_column(u'reviews_detail', 'body', self.gf('tinymce.models.HTMLField')())
    ...
    models = {
        ...
        u'customauth.customuser': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customauth.Country']"}),
        ...
        u'items.itemimage': {
            ...
            'uploaded_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['customauth.CustomUser']"})
        },
        ...
        u'reviews.feedbackeditsuggestion': {
            ...
            'resolved_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'resolvings'", 'null': 'True', 'to': u"orm['customauth.CustomUser']"}),
