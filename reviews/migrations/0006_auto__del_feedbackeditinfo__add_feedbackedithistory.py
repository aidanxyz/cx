...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FeedbackEditHistory'
        db.create_table(u'reviews_feedbackedithistory', (
        ...
        db.send_create_signal(u'reviews', ['FeedbackEditHistory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FeedbackEditHistory'
        db.delete_table(u'reviews_feedbackedithistory')
