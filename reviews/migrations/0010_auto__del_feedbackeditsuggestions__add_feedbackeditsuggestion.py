...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FeedbackEditSuggestions'
        db.delete_table(u'reviews_feedbackeditsuggestions')

        # Adding model 'FeedbackEditSuggestion'
        db.create_table(u'reviews_feedbackeditsuggestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feedback', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.Feedback'])),
            ('suggested_value', self.gf('django.db.models.fields.CharField')(max_length=144)),
            ('suggested_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggestions', to=orm['customauth.CustomUser'])),
            ('date_suggested', self.gf('django.db.models.fields.DateTimeField')()),
            ('is_resolved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('resolved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resolvings', to=orm['customauth.CustomUser'])),
        ))
        db.send_create_signal(u'reviews', ['FeedbackEditSuggestion'])


    def backwards(self, orm):
        # Adding model 'FeedbackEditSuggestions'
        db.create_table(u'reviews_feedbackeditsuggestions', (
            ('feedback', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.Feedback'])),
            ('date_suggested', self.gf('django.db.models.fields.DateTimeField')()),
            ('resolved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='resolvings', to=orm['customauth.CustomUser'])),
            ('suggested_value', self.gf('django.db.models.fields.CharField')(max_length=144)),
        ...
        db.send_create_signal(u'reviews', ['FeedbackEditSuggestions'])

        # Deleting model 'FeedbackEditSuggestion'
        db.delete_table(u'reviews_feedbackeditsuggestion')
    ...
    models = {
        ...
        u'reviews.feedbackeditsuggestion': {
            'Meta': {'object_name': 'FeedbackEditSuggestion'},
            'date_suggested': ('django.db.models.fields.DateTimeField', [], {}),
            'feedback': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reviews.Feedback']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_resolved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'resolved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resolvings'", 'to': u"orm['customauth.CustomUser']"}),
            'suggested_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'suggestions'", 'to': u"orm['customauth.CustomUser']"}),
            'suggested_value': ('django.db.models.fields.CharField', [], {'max_length': '144'})
        },
        u'reviews.priority': {
