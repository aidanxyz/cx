...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedbackEditSuggestion.resolved_by'
        db.alter_column(u'reviews_feedbackeditsuggestion', 'resolved_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['customauth.CustomUser']))

    def backwards(self, orm):

        # Changing field 'FeedbackEditSuggestion.resolved_by'
        db.alter_column(u'reviews_feedbackeditsuggestion', 'resolved_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['customauth.CustomUser']))
    ...
    models = {
        ...
        u'reviews.feedbackeditsuggestion': {
            ...
            'resolved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'resolvings'", 'null': 'True', 'to': u"orm['customauth.CustomUser']"}),
