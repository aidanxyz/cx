...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeedbackCloseInfo.reason'
        db.alter_column(u'reviews_feedbackcloseinfo', 'reason_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.FeedbackEditReason']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FeedbackCloseInfo.reason'
        db.alter_column(u'reviews_feedbackcloseinfo', 'reason_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.ModerationReason']))
