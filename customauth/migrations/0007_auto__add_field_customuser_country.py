...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'customauth_customuser', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['customauth.Country']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.country'
        db.delete_column(u'customauth_customuser', 'country_id')
